...
class SearchCityPageOverlay extends StatelessWidget {
  final VoidCallback onClose;

  const SearchCityPageOverlay({super.key, required this.onClose});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.transparent, // Agar blur kelihatan
      body: SafeArea(
        child: Column(
          children: [
            // Header search
            ...
            const Expanded(
              child: Center(
                child: Text(
                  'Daftar kota akan tampil di sini',
